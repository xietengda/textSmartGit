				...
				<div class="invoType" v-if="selType == 2">
					...
					<div class="inputView">
						...
						<div class="subView" v-if="invoType == 1">
							<input type="text" placeholder="请填写电子邮箱" placeholder-class="placeClass" />
						</div>
						<!--单位-->
						<div class="subView" v-if="invoType == 2">
							<input type="text" placeholder="请填写单位名称" placeholder-class="placeClass" />
							<input type="text" placeholder="请填写纳税人识别号" placeholder-class="placeClass" />
							<input type="text" placeholder="请填写电子邮箱" placeholder-class="placeClass" />
						</div>
					</div>
				</div>
