	...
	<div class="container">
		...
		<div v-show="!netError">
			<div v-show="!nullMsg">
				<!--类型选择-->
				<div class="videoType">
					<div :class="[videoType == 1?'sel':'']" :data-type-id="1" @click="changeType">视频</div>
					<div :class="[videoType == 2?'sel':'']" :data-type-id="2" @click="changeType">专辑</div>
				</div>
				...
				<!--专辑列表-->
				<div class="albumVideoCn" v-show="videoType == 2">
					<albumVideo :albumList="albumList"/>
				</div>
			</div>
