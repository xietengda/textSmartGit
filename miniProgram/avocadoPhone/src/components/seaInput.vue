<template>
	<div class="AllSearch">
		<div class="searchInput">
			...
			<form>
				<input type="text" placeholder="搜一搜" placeholder-class="searchPlace" confirm-type="search" :value="searchText" @confirm="inputText($event)" v-model="searchText" :data-sea-result='seaResult' :focus="foucsText" />
			</form>
			<span class="reset" @click="resetInput"></span>
		</div>
	</div>
</template>
