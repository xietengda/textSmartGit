		...
		<div v-if="hasProduct" class='hasProduct'>
			<div class='Cart_head div_flaot'>
				...
				<div class='Cart_head_R'>
					<div v-if="editBtn" catchtap='editCart'>管理</div>
					<div v-else catchtap='editCart'>完成</div>
				</div>
			</div>
				...
				<block v-for="(item,oneIndex) in cartList" :key='item'>
					<div class='cart_list div_float'>
						<div class='cart_list_L div_float'>
							<div class='cart_sel' :class='[selArr[cartIndex] ? "checkboxSel" : "checkbox"]' :data-sel-index="oneIndex" @click='selChange'></div>
						...
						<div class='cart_list_R'>
							...
							<div class='cart_count div_float'>
								<div catchtap='changeToatl' data-c-type="cut" :data-c-index="oneIndex">-</div>
								<input type='number' :value='item.num' />
								<div catchtap='changeToatl' data-c-type="add" :data-c-index="oneIndex">+</div>
							</div>
						</div>
					</div>
				</block>
			...
			<div class='cart_btm div_float'>
				<div class='cart_btm_L'>
					<div class='cart_all_sel' :class='allSel ? "checkboxSel" : "checkbox"' catchtap='allSel'></div>
					<div>全选</div>
				</div>
	...
	export default {
		data() {
				return {
				    ...
				    editBtn:true,
				    cartList:[
				      {img: '../../../static/img/list2.png', til: '香满楼酸牛奶180克草莓味3盒', subTil: '采用巴氏杀菌，较大限度保留原奶的营养和鲜味', price:'6.9',num:1},
				      { img: '../../../static/img/list2.png', til: '香满楼酸牛奶180克草莓味3盒', subTil: '采用巴氏杀菌，较大限度保留原奶的营养和鲜味', price: '6.9', num: 1 },
				      { img: '../../../static/img/list2.png', til: '香满楼酸牛奶180克草莓味3盒', subTil: '采用巴氏杀菌，较大限度保留原奶的营养和鲜味', price: '6.9', num: 1 }
				    ],
				    selArr:[],
