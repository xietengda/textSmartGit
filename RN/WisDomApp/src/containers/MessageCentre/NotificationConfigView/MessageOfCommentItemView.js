...
export default class MessageOfCommentItemView extends Component {
    render() {
        return(
                ...
                <View style={{flexDirection: 'row', marginHorizontal: Size.scaleSize(44)}}>
                    ...
                    <View style={{left: Size.scaleSize(20), 
                        ...
                        <View style={{height: Size.scaleSize(80), justifyContent: 'space-between',
                            ...
                            <TouchableOpacity style={{position: 'absolute', right: -Size.scaleSize(20), 
                                top: Size.scaleSize(50), width: Size.scaleSize(80), height: Size.scaleSize(40),
                                alignItems: 'center', justifyContent: 'center'}}
                            onPress={()=>{
                                this.props.reply && this.props.reply()
                            }}>
                                <Text style = {{color: Color.font_b1, 
                                    fontSize: Size.scaleSize(24)}}>回复</Text>
                            </TouchableOpacity>
                        </View>

                        <Text style={{color: Color.font_1a, 
                            fontSize: Size.scaleSize(28), 
                            marginTop: Size.scaleSize(40)}}>别人回复的内容</Text>
