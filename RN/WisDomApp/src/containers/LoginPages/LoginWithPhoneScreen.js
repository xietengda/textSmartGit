...
import LoginOfPhoneView from '../LoginPages/LoginOfPhoneView'
    ...
    render () {
        return (
              <View style={styles.constain}>
                  ...
                  <LoginOfPhoneView style={{position: 'absolute', left: Size.scaleSize(75),
                    ...
                    forgetPsd={()=>{
                        this.props.navigation.navigate('ForgetPsdScreen')
                    }}
                    register={()=>{
...
LoginWithPhoneScreen.navigationOptions = ({ navigation }) => ({
  header: null
})
