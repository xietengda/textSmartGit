/*
* @Created by liqihui on 2019-05-16.
* @Desc SingleCourseRow
* @Todo: WisdomApp
...
export default class SingleCourseRow extends Component {
    // 默认属性
    static defaultProps = {};
                    ...
                    <View style={{flex:1,marginLeft:Size.scaleSize(20),justifyContent:'space-between'}}>
                        ...
                        <View>
                            ...
                            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                                <Text style={styles.textDesc}>上次学习：{item.lastLearnTime}</Text>
                                <Text style={[styles.textDesc,{color:Color.primary}]}>已学习{item.status}</Text>
                            </View>
                        </View>
                    </View>
                </View>
