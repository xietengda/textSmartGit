		...
		<div class="sub">
			...
			<div class="saView">
				<div class="saTil div_float">
					...
					<div class="R">
						<div class="sel">
							{{returnType[rIndex]}}<span class="downIcon"></span>
							<picker  @change="reTypeChange" :value="rIndex" :range="returnType">
				...
				<div class="saTil div_float">
					<label>退款金额：</label><span class="price">¥600.00</span>
				</div>
				<div class="saRemark">最多¥600.00，含发货邮费¥0.00</div>
				<div class="saInput">
					<label>退款说明：</label>
					<input type="text" placeholder="选填" placeholder-class="placeClass" />
				</div>
			</div>
			...
			<div class="takePhoto">
				<div class="photoList" v-for="(item,key) in diyImg" :key='key'>
