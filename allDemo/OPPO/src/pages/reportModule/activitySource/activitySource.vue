	...
	<div class="container home" v-wechat-title="$route.meta.title">
		...
		<div class="contentBox">
			...
			<div class="searchBox div_float">
				<div class="s_left">
					<el-select class="selBox" size="small" v-model="selActStatus" filterable placeholder="审核状态">
						<el-option
			...
			<div class="dataTable">
				<el-table
					...
					<el-table-column align="center" label="操作">
						<div class="blueText" @click="skipStoreDetail">查看门店详情</div>
...
<script>
	...
	export default {
		...
		methods:{
			...
			//跳转门店详情
			skipStoreDetail(ele){
				this.$router.push({path:'/actSrouceMsg'})
			}
