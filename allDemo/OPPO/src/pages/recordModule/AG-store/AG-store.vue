AG-store<template>
	<div class="container home" v-wechat-title="$route.meta.title">
		...
		<div class="contentBox">
			...
			<storeInfoMsg  :showLayer="StoreWindow" :storeMsg="storeInfo" @changeStoreLayer="cutChangeEdit" @changeProvinces="storeProvinces" :disablesInput="false" @changeMsg="changeStoreMsg"/>
