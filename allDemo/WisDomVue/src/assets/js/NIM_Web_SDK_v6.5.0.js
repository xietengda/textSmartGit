! function (e, t) {
  ...
  return function (e) {
    ...
    l.deduplicate = function (e) {
      ...
      return l.verifyParamPresent("fileInput", e, "", t), l.isString(e) && ((e = "undefined" == typeof document ? void 0 : document.getElementById(e)) || l.onParamError("找不到要上传的文件对应的input, 请检查fileInput id " + e, t)), e.tagName && "input" === e.tagName.toLowerCase() && "file" === e.type.toLowerCase() || l.onParamError("请提供正确的 fileInput, 必须为 file 类型的 input 节点 tagname:" + e.tagName + ", filetype:" + e.type, t), e
    ...
    var r = {
      info: {
        hash: "8b41247f400865cf508a5565c0a3dedd972f8282",
        shortHash: "8b41247f",
        version: "6.5.0",
        sdkVersion: "52",
        nrtcVersion: "4.6.0",
    ...
    (function (t) {
      ...
      var o = function () {
        ...
        return function t(n) {
          ...
          var z = {};
          return z.description = n, z.layout = D && D[0], z.manufacturer = q, z.name = L, z.prerelease = j, z.product = B, z.ua = n, z.version = L && F, z.os = H || {
            architecture: null,
            family: null,
            version: null,
            toString: function () {
          ...
          }, z.version && U.unshift(F), z.name && U.unshift(L), H && L && (H != String(H).split(" ")[0] || H != L.split(" ")[0] && !B) && U.push(B ? "(" + H + ")" : "on " + H), U.length && (z.description = U.join(" ")), z
        }()
      }();
      e.exports = o
    }).call(this, n(31))
    ...
    var r = n(8),
      ...
      X = function (e, t, n) {
        return e === B && X(L, t, n), v(e), t = T(t, !0), v(n), s(D, t) ? (n.enumerable ? (s(e, U) && e[U][t] && (e[U][t] = !1), n = k(n, {
          enumerable: S(0, !1)
        })) : (s(e, U) || w(e, U, S(1, {})), e[U][t] = !0), z(e, t, n)) : w(e, t, n)
      },
      $ = function (e, t) {
        v(e);
    ...
    q || (a((_ = function () {
      ...
      return this._k
    }), P.f = K, I.f = X, n(60).f = C.f = Q, n(28).f = G, n(38).f = Y, i && !n(35) && a(B, "propertyIsEnumerable", G, !0), f.f = function (e) {
      return J(p(e))
    }), o(o.G + o.W + o.F * !q, {
      Symbol: _
    });
    ...
    e.exports = function (e, t, n) {
      ...
      function c(t) {
        ...
        else if (t.offset < o.fileSize) delete l.onaftersend, o.fileUoloadedSize = t.offset, n.sn = function (e, t, n, r, o) {
          var l = t.offset,
            m = t.offset + s;
    ...
    o.sendText = function (e) {
      ...
      if (l.isWeixinApp) a.verifyOptions(e, "filePath", "msg::_doPreviewFile"), n.fileQuickTransfer(e, p, function () {
        wx.uploadFile({
          url: t,
          filePath: e.filePath,
          name: "file",
    ...
    r.onDeleteMsg = function (e) {
      ...
      if (r.enable && e) {
        ...
        return r.getMsgs({
          ...
          if (n.options.rollbackDelMsgUnread) return r.getSessions({
            sessionId: c
          })
        }).then(function (e) {
          var t = {
    ...
    r.processTeam = function (e) {
      ...
      function d() {
        n.timetags.teams = t, u.invalid = l, s ? (n.syncResult.teams = u, n.syncResult.invalidTeams = l, n.syncing || n.onSyncDone()) : (n.logger.info("team::onTeams: not in syncing, get teams", o(u), u), e.obj = u)
      }
    ...
    o.beforeSync = function () {
      ...
      function L() {
        var e, t, r = [];
        n && (_.logger.info("sync::notifyDataAsync: on blacklist", m(n), n), U.onblacklist(n)), s && (_.logger.info("sync::notifyDataAsync: on mutelist", m(s), s), U.onmutelist(s)), f && (_.logger.info("sync::notifyDataAsync: on friends", m(f), f), U.onfriends(f)), h && (_.logger.info("sync::notifyDataAsync: on myInfo", h), _.myInfo = h, U.onmyinfo(a.copy(h))), y && (y.forEach(function (e) {
          _.mergeUser(e)
        ...
        }), i.length && (P = (P = P || []).concat(i)), o.length && (I = (I = I || []).concat(o)), P && (_.logger.info("sync::notifyDataAsync: on roaming sys msgs", P.length, P), U.onroamingsysmsgs(P)), I && (_.logger.info("sync::notifyDataAsync: on offline sys msgs", I.length, I), U.onofflinesysmsgs(I)), x && (_.logger.info("sync::notifyDataAsync: on offline filter sys msgs", x.length, x), U.onofflinefiltersysmsgs(x)), O && (_.logger.info("sync::notifyDataAsync: on offline custom sys msgs", O.length, O), U.onofflinecustomsysmsgs(O)), w && (_.logger.info("sync::notifyDataAsync: on offline filter custom sys msgs", w.length, w), U.onofflinefiltercustomsysmsgs(w)), A && (A = a.merge({}, _.sysMsgUnread, A), _.sysMsgUnread = a.merge({}, A), _.logger.info("sync::notifyDataAsync: on sysMsgUnread", A), U.onsysmsgunread(A));
        var c = _.getPushNotificationMultiportConfig();
        _.logger.info("sync::notifyDataAsync: on pushNotificationMultiportConfig", c), U.onPushNotificationMultiportConfig(c), r.length ? (e = Math.max.apply(Math, r), _.updateRoamingMsgTimetag(e).then(B, B)) : B(), _.syncPromiseArray = [], _.syncResult = {}
      }

      function B() {
        if (_.processUnsettledMsgs(), _.processUnsettledSysMsgs(), _.syncing && U.onsyncdone(), _.syncing = !1, U.syncTeamMembers && v && v.length) throw new c("sync team members api deprecated!")
      }! function () {
        if (!j) return void _.logger.warn("sync::onSyncDone: after sync --no promiseArray");
        if (_.logger.info("sync::onSyncDone: after sync", a.promises2cmds(j)), j = [], n = N.blacklist || [], r = N.invalidBlacklist || [], s = N.mutelist || [], o = N.invalidMutelist || [], f = N.friends, g = N.invalidFriends || [], h = N.myInfo, y = N.users, v = N.teams, b = N.invalidTeams || [], M = N.sessions, T = N.msgReceipts, S = N.roamingMsgs, k = N.offlineMsgs, C = N.offlineFilterMsgs, I = N.offlineSysMsgs, O = N.offlineCustomSysMsgs, x = N.offlineFilterSysMsgs, w = N.offlineFilterCustomSysMsgs, N.broadcastMsgs, A = N.sysMsgUnread, M) {
          var e = [];
        ...
        c.then(function () {
          ...
          0 === a.length && a.push(Promise.resolve()), Promise.all(a).then(function () {
            ...
            e.callFunc = "sync::onSyncDone", e.message = "afterSync syncFullDataPromise 出错", _.onCustomError("SYNC_NORMAL_ERROR", e)
          }).then(D, function (e) {
    ...
    r.putMsg = function (e) {
      ...
      return this.getOnly("msg1", "sessionId", e.sessionId, {
        remove: !0
      })
