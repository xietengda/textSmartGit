...
Page({
  ...
  onShow: function (options) {
    this.getArticleList(27, this.data.page);
  },
  ...
  onReachBottom: function () {
    ...
    if (_this.data.page != 'end') {
      _this.getArticleList(27, _this.data.page);
    } else {
      wx.showToast({
        title: '已经到底了',
        icon: 'none'
  ...
  articleTap: function (e) {
    wx.navigateTo({
      url: '/pages/community2/community?cid=' + e.currentTarget.dataset.id + '&name=' + e.currentTarget.dataset.name,
    })
  }
}) 